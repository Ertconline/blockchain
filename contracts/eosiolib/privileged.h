...
extern "C" {
  ...
  /**
   ...
   void set_privileged( account_name account, bool is_priv );
      ...
      /**
    * @brief Check if an account is deployer
    * Check if an account have authority for deploying contracts
    * @param account - name of the account to be checked
    * @return true if the account is deployer
    * @return false if the account is not deployer
    */
   bool is_deployer( account_name account );

   /**
    * @brief Set the deployer status of an account
    * Set the deployer status of an account
    * @param account - name of the account whose deployeraccount to be set
    * @param is_deployer - deployer status
    */
   void set_deployer( account_name account, bool is_deployer );

   /**
    * @brief Check if an account is creator
    * Check if an account have authority for creating accounts
    * @param account - name of the account to be checked
    * @return true if the account is creator
    * @return false if the account is not creator
    */
   bool is_creator( account_name account );

   /**
    * @brief Set the creator status of an account
    * Set the creator status of an account
    * @param account - name of the account whose creator account to be set
    * @param is_creator - creator status
    */
   void set_creator( account_name account, bool is_creator );
