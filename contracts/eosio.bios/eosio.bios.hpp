...
namespace eosio {
   ...
   class bios : public contract {
      public:
         ...
         void setcreator( account_name account, uint8_t iscreator ) {
            require_auth( _self );
            set_creator( account, iscreator );
         }

         void setdeployer( account_name account, uint8_t isdeployer ) {
            require_auth( _self );
            set_deployer( account, isdeployer );
         }
